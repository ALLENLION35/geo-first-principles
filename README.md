...
作者：allenlion · 版本：1.0 · 许可证：[MIT](LICENSE)
...
一份面向企业、能够指导取舍的六部分报告。形式可为 Markdown、HTML、对话正文或应用支持的其他形式；可以指定，也可以由模型按阅读和展示需要选择：
...
6. **企业的 GEO 布局与投入建议**：把客户问题、真实资料、内容渠道、业务承接与资源安排连成一条行动路线。

结尾按**最终判断、生意本质、GEO 的价值、最值得的做法、投入取舍**形成独立可读的决定。
...
| `references/planning-and-handoff.md` | 行动路线、实测操作、记录与模型条件 |
...
竞争研究需要联网能力；无法联网时基于已有材料分析，并说明待核对的竞争信息。无法绘图时用阶段表。报告格式按需求与应用能力选择，HTML 可直接生成，无需先生成 Markdown；多种版本使用同一套分析，保持事实、引用、五题与结论一致。
